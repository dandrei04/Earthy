...
if (isset($_POST['events'])) {
    ...
    if ($_SESSION['city'] != '0') {
        ...
        if ($_SESSION['event_sort'] == 1) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_city = '$city' AND event_date > '$date_now' ORDER BY event_date_create DESC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 2) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_city = '$city' AND event_date > '$date_now' ORDER BY event_date ASC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 3) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_city = '$city' AND event_date > '$date_now' ORDER BY event_likes, event_date ASC DESC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 4) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_city = '$city' AND event_date > '$date_now' ORDER BY event_going DESC, event_date ASC LIMIT $number_events";
        }
        ...
        if ($_SESSION['event_sort'] == 1) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_date > '$date_now' ORDER BY event_date_create DESC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 2) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_date > '$date_now' ORDER BY event_date ASC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 3) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_date > '$date_now' ORDER BY event_likes DESC, event_date ASC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 4) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_state = '$state' AND event_date > '$date_now' ORDER BY event_going DESC, event_date ASC LIMIT $number_events";
        }
        ...
        if ($_SESSION['event_sort'] == 1) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_date > '$date_now' ORDER BY event_date_create DESC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 2) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_date > '$date_now' ORDER BY event_date ASC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 3) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_date > '$date_now' ORDER BY event_likes, event_date ASC DESC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 4) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_country = '$country' AND event_date > '$date_now' ORDER BY event_going DESC, event_date ASC LIMIT $number_events";
        }
        ...
        if ($_SESSION['event_sort'] == 1) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_date > '$date_now' ORDER BY event_date_create DESC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 2) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_date > '$date_now' ORDER BY event_date ASC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 3) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_date > '$date_now' ORDER BY event_likes DESC, event_date ASC LIMIT $number_events";
        }
        else if($_SESSION['event_sort'] == 4) {
            $sql = "SELECT * FROM events WHERE event_userid != '$id' AND event_date > '$date_now' ORDER BY event_going DESC, event_date ASC LIMIT $number_events";
        }
    }
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($row['event_hour'] < 10) {$hour = "0".$row['event_hour'];}
            else $hour = $row['event_hour'];

            if ($row['event_minute'] < 10) {$minute = "0".$row['event_minute'];}
            else $minute = $row['event_minute'];
    ...
    echo '<button id="moreEvents" onclick="showMore()">Show More</button>';
}