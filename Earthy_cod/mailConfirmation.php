...
<!-- Design taken from codepen --> 


<link rel="stylesheet" href="css/mailConfirmation.css">
<script src="js/mailConfirmation.js"></script>
<?php include 'logout_permission.php'; ?>

<head>
    <title>Earthy | Confirmation</title>
</head>
...
<body class="permission_denied">
  ...
  <div class="denied__wrapper">
    ...
    <?php 
        ...
        if(isset($_GET['error'])) {
            if($_GET['error'] == 'sqlerror') echo ' <h1>Oops!</h1> <h3>THERE WAS AN ERROR IN<span>SPACE</span> EARTHY! Hmm, please try again later.</h3>';
            else if($_GET['error'] == 'invalidlink') echo ' <h1>Oops!</h1> <h3>THERE WAS AN ERROR IN<span>SPACE</span> EARTHY! Hmm, maybe the link is too old?</h3>';
            else if($_GET['error'] == 'succes') echo ' <h1>Hooray!</h1> <h3>NOW YOU CAN DIVE INTO<span>SPACE</span> EARTHY! Make your stay worthy!</h3>';
        }
        else {
