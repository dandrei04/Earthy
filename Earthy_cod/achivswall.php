...
<link rel="stylesheet" href="css/achivswall.css">
<script src="js/achivswall.js"></script>
...
<div id="achivs-posts">
    <?php 
        ...
        if ($_SESSION['achiv_sort'] == 1) {
            $sql = "SELECT * FROM achievements WHERE achiv_userid != '$id' ORDER BY achiv_date_create DESC LIMIT 4";
        }
        else if ($_SESSION['achiv_sort'] == 2) {
            $sql = "SELECT * FROM achievements WHERE achiv_userid != '$id' ORDER BY achiv_likes DESC LIMIT 4";
        }
    ...
    <button id="moreAchivs" onclick="showMore()">Show More</button>
